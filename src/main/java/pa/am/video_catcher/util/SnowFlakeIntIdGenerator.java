 ...
 */
public class SnowFlakeIntIdGenerator {
    ...
    private static SnowFlakeIntIdGenerator instance;

    // ==============================Constructors=====================================

    public static SnowFlakeIntIdGenerator getInstance() {
        if(instance == null) {
            instance = new SnowFlakeIntIdGenerator();
        }
        return instance;
    }
